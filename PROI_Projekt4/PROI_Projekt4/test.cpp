...
TEST_CASE("Client class")
{
	...
	{
		Client cl("PePe  ", "PEpegus ", "Passport", "21304124241", 123421, "2412", Product());
	...
	//{
		Client cl("JoHn  ", "Bree", "Passport", "21304124241", 123421, "2412", Product());
	...
	////}
	//SECTION("Modifying products") // changed structure
	//{
	//	//Client cl("JoHn  ", "Bree", "Passport", "21304124241", 123421, "2412", Product());
...
//	//SECTION("Queue")
//	//{
//	c1.newClient(Client("JoHn  ", "Bree", "Passport", "54404124241", 123421, "1412", Product()));
//	c1.newClient(Client("PePe  ", "PEpegus ", "Passport", "21304214241", 763421, "2212", Product()));
...
//	REQUIRE(c1.getQueue().size() == 0);
//	c1.newClient(Client("PePe  ", "PEpegus ", "Passport", "21304214241", 763421, "2212", Product()));
//	REQUIRE_THROWS_AS(c1.clientLeft(Client("JoHn  ", "Bree", "Passport", "54404124241", 121421, "1412", Product())), ClientNotFound);
//	c1.clientLeft(Client("PePe  ", "PEpegus ", "Passport", "21304214241", 763421, "2212", Product()));
//	REQUIRE(c1.getQueue().size() == 0);
//	//}
//	//SECTION("Employee")
//	//{
